...
public class AxSpoofManager implements IAxSpoofManager {
    ...
    private static final String[] WATCHED_KEYS = {
            ...
            Settings.Secure.SPOOF_PIF_NETFLIX,
            Settings.Secure.SPOOF_PIF_SNAPCHAT,
    ...
    @Override
    public String getPifSpoofNetflix() {
        return getCached(Settings.Secure.SPOOF_PIF_NETFLIX);
    }

    @Override
    public String getPifSpoofSnapchat() {
        return getCached(Settings.Secure.SPOOF_PIF_SNAPCHAT);
    }

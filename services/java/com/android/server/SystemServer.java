...
public final class SystemServer implements Dumpable {
    ...
    private void run() {
        ...
        try {
            ...
            NtServiceInjector.get().setCtx(mSystemContext);
    ...
    private void startBootstrapServices(@NonNull TimingsTraceAndSlog t) {
        ...
        NtServiceInjector.get().setActivityManagerService(mActivityManagerService);
        t.traceEnd();
        ...
        NtServiceInjector.get().setPackageManagerService(mPackageManagerService);

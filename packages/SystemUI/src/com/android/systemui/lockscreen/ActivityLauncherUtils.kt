...
class ActivityLauncherUtils(private val context: Context) {
    ...
    private val activityStarter: ActivityStarter? by lazy { Dependency.get(ActivityStarter::class.java) }
    ...
    fun launchWalletApp() {
        val launchIntent = packageManager.getLaunchIntentForPackage("com.google.android.apps.walletnfcrel")?.apply {

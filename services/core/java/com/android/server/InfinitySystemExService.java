...
public class InfinitySystemExService extends SystemService {

    private static final String TAG = "InfinitySystemExService";
    ...
    public InfinitySystemExService(Context context) {
        super(context);
    ...
    private final class PackageRemovedListener extends LauncherApps.Callback {
        ...
        public void onPackageRemoved(String packageName, UserHandle user) {
            ...
            InfinitySystemExService.this.onPackageRemoved(packageName);
        }

...
public class UdfpsAnimation extends ImageView {
    ...
    private static final String UDFPS_ANIMATIONS_PACKAGE = "com.infinity.udfps.animations";
    ...
    private final ContentObserver mAnimStyleObserver = new ContentObserver(
    ...
    private void addAnimation() {
        if (!mAnimationAdded) {
            ...
            mContext.getContentResolver().registerContentObserver(
                    Settings.System.getUriFor(Settings.System.UDFPS_ANIM_STYLE),
                    false, mAnimStyleObserver, UserHandle.USER_CURRENT);
    ...
    public void removeAnimation() {
        hide();
        if (mAnimationAdded) {
            mContext.getContentResolver().unregisterContentObserver(mAnimStyleObserver);

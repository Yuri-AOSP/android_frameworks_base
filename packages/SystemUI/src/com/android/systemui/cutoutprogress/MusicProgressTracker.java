...
public final class MusicProgressTracker {
    ...
    private final MediaSessionTrackHelper mHelper;
    ...
    private final MediaSessionTrackHelper.MediaMetadataListener mListener =
            new MediaSessionTrackHelper.MediaMetadataListener() {
                @Override
    ...
    public MusicProgressTracker(MediaSessionTrackHelper helper, Callbacks callbacks) {
        mHelper = helper;
